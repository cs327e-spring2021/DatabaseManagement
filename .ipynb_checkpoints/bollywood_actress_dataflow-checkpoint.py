...
def run():
     ...
     sql = 'SELECT distinct a.Name, a.Height_in_cm_, a.Debut_aslead_role from datamart.bollywood_actress a join datamart.bollywood b on b.Title=a.Debut_aslead_role'
    ...
    # outputs result to output.txt
     out_pcoll | 'Log output' >> WriteToText(DIR_PATH + 'actress_output.txt')

    # get appropriate schema id for datamart.bollywood_actress_beam
     dataset_id = 'datamart'
     table_id = PROJECT_ID + ':' + dataset_id + '.' + 'bollywood_actress_dataflow'
